            ...
            <div class='leftbox'>
                ...
                <div class='pie'>
                    <div style="width: 229px; height: 293px; left: 19px; top: 38px; position: absolute">
                        ...
                        <div style="width: 200px; height: 200px; left: 35px; top: 65px; position: absolute; background: conic-gradient(#1A60E7 <?= $weeklycardiopct ?>,
                    #d9d9d9 0);; border-radius: 9999px">
                        ...
                        <div style="width: 150px; height: 150px; left: 55px; top: 90px; position: absolute; background: conic-gradient(#163F8C <?= $dailycardiopct ?>,
                    #d9d9d9 0); border-radius: 9999px">
                        </div>
                        <div
                            style="width: 125px; height: 125px; left: 67px; top: 102px; position: absolute; background: #D9D9D9; border-radius: 9999px">
                        </div>
                        <div style="width: 100px; height: 100px; left: 79px; top: 115px; position: absolute; background:conic-gradient(#D52C73 <?= $execstatus ?>,
                    #d9d9d9 0); border-radius: 9999px">
                        </div>
                        <div
